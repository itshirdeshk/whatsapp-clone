...
class ChatRepository {
    ...
    return firestore
      ...
      (event) {
        ...
        for (var document in event.docs) {
          ...
          if (group.membersIUid.contains(auth.currentUser!.uid)) {
            groups.add(group);
          }
        }
        return groups;
  ...
  Stream<List<Messages>> getGroupChatStream(String groupId) {
    return firestore
        .collection('groups')
        .doc(groupId)
        .collection('chats')
  ...
  void _saveMessageToMessageSubCollection({
    ...
    final message = Messages(
      ...
      messageId: messageId,
      isSeen: false,
      repliedMesage: messageReply == null ? '' : messageReply.message,
